...
This guide describes how to build bgcoind, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run bgcoind or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/BGCoinDev/bgcoin/blob/master/doc/descriptors.md).
