...
[BIP 174](https://github.com/bgcoin/bips/blob/master/bip-0174.mediawiki)).
...
[CoinJoin](https://bgcointalk.org/?topic=279249) transactions.
...
the command line in case `bgcoin-cli` is used.
...
Later, when *V* BGCO has been received on *Amulti*, and Bob and Carol want to
