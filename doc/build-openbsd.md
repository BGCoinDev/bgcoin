...
This guide describes how to build bgcoind, command-line utilities, and GUI on OpenBSD.
...
It is not necessary to build wallet functionality to run either `bgcoind` or `bgcoin-qt`.
...
...
to: /path/to/bgcoin/depends/*-unknown-openbsd*
```
...
(see issue [#6658](https://github.com/BGCoinDev/bgcoin/issues/6658)).
