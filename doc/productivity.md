...
```sh
cmake --build build --target bgcoind bgcoin-cli
cmake --build build --target bgcoin-qt
cmake --build build --target bench_bgcoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:bgcoin/bgcoin.git
```
