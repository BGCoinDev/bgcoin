...
debug log about your I2P configuration and connections. Run `bgcoin-cli help
...
attacks](https://en.bgcoin.it/wiki/Weaknesses#Sybil_attack). You can use
`bgcoin-cli -addrinfo` to see the number of I2P addresses known to your node.
...
To see which I2P peers your node is connected to, use `bgcoin-cli -netinfo 4`
or the `getpeerinfo` RPC (e.g. `bgcoin-cli getpeerinfo`).

You can use the `getnodeaddresses` RPC to fetch a number of I2P peers known to your node; run `bgcoin-cli help getnodeaddresses` for details.
