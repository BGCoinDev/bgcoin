...
router", implementing the bgcoin wire protocol and relay, making
...
terminator). These options can also be provided in bgcoin.conf.
...
From the perspective of bgcoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into bgcoind directly. Furthermore, no information is
