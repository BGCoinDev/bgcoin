...
Multiple tools can list the available tracepoints in a `bgcoind` binary with
USDT support.
...
```
$ gdb ./build/src/bgcoind
…
(gdb) info probes
Type Provider   Name             Where              Semaphore Object
stap net        inbound_message  0x000000000014419e /build/src/bgcoind
stap net        outbound_message 0x0000000000107c05 /build/src/bgcoind
stap validation block_connected  0x00000000002fb10c /build/src/bgcoind
…
```
...
```
$ readelf -n ./build/src/bgcoind | grep NT_STAPSDT -A 4 -B 2
