...
function(add_maintenance_targets)
  ...
  foreach(target IN ITEMS bgcoind bgcoin-qt bgcoin-cli bgcoin-tx bgcoin-util bgcoin-wallet test_bgcoin bench_bgcoin)
    if(TARGET ${target})
...
function(add_windows_deploy_target)
  if(MINGW AND TARGET bgcoin-qt AND TARGET bgcoind AND TARGET bgcoin-cli AND TARGET bgcoin-tx AND TARGET bgcoin-wallet AND TARGET bgcoin-util AND TARGET test_bgcoin)
    # TODO: Consider replacing this code with the CPack NSIS Generator.
    #       See https://cmake.org/cmake/help/latest/cpack_gen/nsis.html
    include(GenerateSetupNsi)
    generate_setup_nsi()
    add_custom_command(
      OUTPUT ${PROJECT_BINARY_DIR}/bgcoin-win64-setup.exe
      COMMAND ${CMAKE_COMMAND} -E make_directory ${PROJECT_BINARY_DIR}/release
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:bgcoin-qt> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:bgcoin-qt>
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:bgcoind> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:bgcoind>
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:bgcoin-cli> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:bgcoin-cli>
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:bgcoin-tx> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:bgcoin-tx>
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:bgcoin-wallet> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:bgcoin-wallet>
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:bgcoin-util> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:bgcoin-util>
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:test_bgcoin> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:test_bgcoin>
      COMMAND makensis -V2 ${PROJECT_BINARY_DIR}/bgcoin-win64-setup.nsi
      VERBATIM
    )
    add_custom_target(deploy DEPENDS ${PROJECT_BINARY_DIR}/bgcoin-win64-setup.exe)
  endif()
endfunction()

function(add_macos_deploy_target)
  if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" AND TARGET bgcoin-qt)
    ...
    configure_file(${PROJECT_SOURCE_DIR}/src/qt/res/icons/bgcoin.icns ${macos_app}/Contents/Resources/bgcoin.icns NO_SOURCE_PERMISSIONS COPYONLY)
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_COMMAND} -E rename ${macos_app}/Contents/MacOS/bin/$<TARGET_FILE_NAME:bgcoin-qt> ${macos_app}/Contents/MacOS/Bitcoin-Qt
    ...
    add_dependencies(deploydir bgcoin-qt)
