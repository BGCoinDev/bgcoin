...
[good first issue](https://github.com/BGCoinDev/bgcoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/BGCoinDev/bgcoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Bitcoin Core PR Review Club](https://bgcoincore.reviews/) meeting.
...
`#bgcoin-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#bgcoin-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/bgcoin-core-dev/](https://www.erisian.com.au/bgcoin-core-dev/)
and [https://gnusha.org/bgcoin-core-dev/](https://gnusha.org/bgcoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://groups.google.com/g/bgcoindev)
should be used to discuss complicated or controversial consensus or P2P protocol changes before working on
a patch set.
Archives can be found on [https://gnusha.org/pi/bgcoindev/](https://gnusha.org/pi/bgcoindev/).
...
For GUI-related issues or pull requests, the https://github.com/bgcoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/BGCoinDev/bgcoin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bgcoin-qt
...
[Translation Process](https://github.com/BGCoinDev/bgcoin/blob/master/doc/translation_process.md)
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/BGCoinDev/bgcoin  # Fetch the latest upstream commit
...
https://github.com/BGCoinDev/bgcoin/pull/16189).

Also see the [backport.py script](
https://github.com/bgcoin-core/bgcoin-maintainer-tools#backport).
