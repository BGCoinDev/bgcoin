...
3. After the PR is merged, tag the commit, and push the tag:
   ...
   git push git@github.com:bgcoin-core/secp256k1.git v$MAJOR.$MINOR.$PATCH
   ```
...
6. Send an announcement email to the bgcoin-dev mailing list.
...
1. If there's no maintenance branch `$MAJOR.$MINOR`, create one:
   ...
   git push git@github.com:bgcoin-core/secp256k1.git $MAJOR.$MINOR
   ```
...
7. Send an announcement email to the bgcoin-dev mailing list.
