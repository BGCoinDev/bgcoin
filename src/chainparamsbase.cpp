...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 11964, 11966);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 21964, 21966);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 31964, 31966);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 41964, 21966);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 51964, 51966);
    }
    assert(false);
}
