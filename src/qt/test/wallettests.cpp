...
#include <key_io.h>
#include <qt/bgcoinamountfield.h>
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_bgcoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_bgcoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_bgcoin-qt  # macOS
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        qWarning() << "Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
                      "with 'QT_QPA_PLATFORM=cocoa test_bgcoin-qt' on mac, or else use a linux or windows build.";
        return;
    }
#endif
    TestGUI(m_node);
