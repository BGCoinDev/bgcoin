...
{
    // Test regression https://github.com/BGCoinDev/bgcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bgcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bgcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Bitcoin/Bitcoin-Qt.conf and all else left as default,
    // bgcoin-qt should set both -listen and -listenonion to false and start successfully.
