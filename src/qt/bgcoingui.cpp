...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bgcoin: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a bgcoin: URI"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to BGCoin network.", "", count);
    } else {
        //: A substring of the tooltip.
