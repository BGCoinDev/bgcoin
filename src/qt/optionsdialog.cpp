      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bgcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bgcoinAtStartup);
    ...
    ui->bgcoinAtStartup->setToolTip(ui->bgcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bgcoinAtStartup->setText(ui->bgcoinAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->bgcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBGCOontrols);
