...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // bgcoin.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/BGCoinDev/bgcoin/issues/16220 about ways to
        ...
        // Show an error or warning if there is a bgcoin.conf file in the
