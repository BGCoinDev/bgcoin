...
const std::string CURRENCY_UNIT = "BGCO"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BGCO_KVB,      //!< Use BGCO/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BGCO_KVB) const;
