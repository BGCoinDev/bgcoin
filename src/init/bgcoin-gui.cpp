...
namespace init {
namespace {
const char* EXE_NAME = "bgcoin-gui";
...
public:
    ...
    // bgcoin-gui accepts -ipcbind option even though it does not use it
    // directly. It just returns true here to accept the option because
    // bgcoin-node accepts the option, and bgcoin-gui accepts all bgcoin-node
