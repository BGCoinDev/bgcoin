...
static RPCHelpMan waitfornewblock()
{
    return RPCHelpMan{"waitfornewblock",
                ...
                "\nMake sure to use no RPC timeout (bgcoin-cli -rpcclienttimeout=0)",
                {
...
UniValue DeploymentInfo(const CBlockIndex* blockindex, const ChainstateManager& chainman)
{
    ...
    SoftForkDescPushBack(blockindex, softforks, chainman, Consensus::DEPLOYMENT_CONS);
    return softforks;
}
} // anon namespace
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{"scanblocks",
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (bgcoin-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
    ...
    const std::function<void()>& interruption_point)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/BGCoinDev/bgcoin/pull/15606#discussion_r274479369
        //
        AssertLockHeld(::cs_main);
    ...
    const std::function<void()>& interruption_point)
{
    ...
    // See also https://github.com/BGCoinDev/bgcoin/issues/25675
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "The result is a usable bgcoind instance that is current with the network tip in a "
        ...
        "document (<https://github.com/BGCoinDev/bgcoin/blob/master/doc/design/assumeutxo.md>).",
        {
            {"path",
                RPCArg::Type::STR,
                RPCArg::Optional::NO,
