...
"""Test framework for bgcoin utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "bgcoin-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./bgcoin-util":
        execprog = os.getenv("BITCOINUTIL", default=execprog)
    elif testObj["exec"] == "./bgcoin-tx":
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, bgcoin-tx
