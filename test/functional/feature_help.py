...
"""Verify that starting bgcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bgcoin with -h for help text")
        ...
        self.log.info("Start bgcoin with -version for version information")
        ...
        self.log.info("Start bgcoind with -fakearg to make sure it does not start")
