...
class FullBlockTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [[
            ...
            '-par=1', # Until https://github.com/BGCoinDev/bgcoin/issues/30960 is fixed
        ]]
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure bgcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure bgcoind isn't accepting b28
        ...
        # bgcoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the bgcoin code has custom code which does so);
