...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BGCO from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BGCO with subtract fee from amount
        ...
        # Sendmany 10 BGCO with subtract fee from amount
        ...
        # Sendmany 5 BGCO to two addresses with subtracting fee from both addresses
