...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def getrawtransaction_verbosity_tests(self):
        ...
        # Do this with a pruned chain, as a regression test for https://github.com/BGCoinDev/bgcoin/pull/29003
    ...
    def sendrawtransaction_testmempoolaccept_tests(self):
        ...
        # Fee rate is 0.00100000 BGCO/kvB
        ...
        # Fee rate is 0.20000000 BGCO/kvB
    ...
    def decoderawtransaction_tests(self):
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain (see https://github.com/BGCoinDev/bgcoin/issues/20579)
