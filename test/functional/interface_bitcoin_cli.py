...
# The block reward of coinbaseoutput.nValue (50) BGCO/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BGCO/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"bgcoin-cli -h\" for help or \"bgcoin-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bgcoin-cli getblockchaininfo`")
        ...
        # Prevent bgcoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and bgcoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bgcoin-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (BGCO/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (BGCO/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 BGCO) to the default wallet.
            ...
            # Test bgcoin-cli -generate with -rpcwallet in multiwallet mode.
