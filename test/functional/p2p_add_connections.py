...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The bgcoind node closes feeler connections as soon as a version
...
class P2PAddConnections(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # bgcoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that bgcoind sends its own version prior to processing
