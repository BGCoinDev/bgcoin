...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BGCO:
        ...
        # First: use raw transaction API to send 1240 BGCO to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BGCO coin each
        ...
        # Node0's balance should be starting balance, plus 50BGCO for another
        ...
        # Node0's total balance should be starting balance, plus 100BGCO for
