...
(
    ...
    case "$HOST" in
        *mingw*)
            ...
            mv build/bgcoin-win64-setup.exe "${OUTDIR}/${DISTNAME}-win64-setup-unsigned.exe"
            ;;
    esac
    ...
    (
        ...
        # copy over the example bgcoin.conf file. if contrib/devtools/gen-bgcoin-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/share/examples/bgcoin.conf" "${DISTNAME}/"
