...
BITCOIND=${BITCOIND:-$BINDIR/bgcoind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/bgcoin.conf}
...
then
  ...
  echo -e "To safely generate a bgcoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example bgcoin.conf file in share/examples/'
...
##
## bgcoin.conf configuration file.
## Generated by contrib/devtools/gen-bgcoin-conf.sh.
##
...
# parse the output from bgcoind --help
