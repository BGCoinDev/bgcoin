...
declare -A LIBS
LIBS[cli]="libbgcoin_cli.a"
LIBS[common]="libbgcoin_common.a"
LIBS[consensus]="libbgcoin_consensus.a"
LIBS[crypto]="crypto/libbgcoin_crypto.a crypto/libbgcoin_crypto_x86_shani.a crypto/libbgcoin_crypto_sse41.a crypto/libbgcoin_crypto_avx2.a"
LIBS[node]="libbgcoin_node.a"
LIBS[util]="util/libbgcoin_util.a"
LIBS[wallet]="wallet/libbgcoin_wallet.a"
...
# https://github.com/BGCoinDev/bgcoin/issues/10102
