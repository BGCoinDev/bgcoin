...
complete --command bgcoind --no-files

# Extract options
function __fish_bgcoind_get_options
...
complete \
    --command bgcoind \
    --arguments "(__fish_bgcoind_get_options --nofiles)"
