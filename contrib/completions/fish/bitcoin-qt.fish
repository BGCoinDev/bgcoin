...
complete --command bgcoin-qt --no-files

# Extract options
function __fish_bgcoinqt_get_options
...
complete \
    --command bgcoin-qt \
    --arguments "(__fish_bgcoinqt_get_options --nofiles)"
