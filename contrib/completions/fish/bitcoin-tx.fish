...
# Extract options
function __fish_bgcoin_tx_get_options
...
# Extract commands
function __fish_bgcoin_tx_get_commands
...
complete \
    --command bgcoin-tx \
    --condition "not __fish_bgcoin_seen_cmd (__fish_bgcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bgcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bgcoin-tx \
    --arguments "(__fish_bgcoin_tx_get_commands)" \
    --no-files
