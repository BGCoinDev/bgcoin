...
of the [guix.sigs repository](https://github.com/bgcoin-core/guix.sigs/). When
...
builder-keys](https://github.com/bgcoin-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://bgcoincore.org and https://blackgoldcoin.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/bgcoin-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/bgcoin-24.0.1-arm-linux-gnueabihf.tar.gz
```
