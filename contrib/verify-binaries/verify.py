...
signature file SHA256SUMS.asc from bgcoincore.org and blackgoldcoin.org and
compares them.
...
The builder keys are available in the guix.sigs repo:
    ...
    https://github.com/bgcoin-core/guix.sigs/tree/main/builder-keys
...
HOST1 = "https://bgcoincore.org"
HOST2 = "https://blackgoldcoin.org"
VERSIONPREFIX = "bgcoin-core-"
...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    WORKINGDIR = Path(tempfile.gettempdir()) / f"bgcoin_verify_binaries.{args.version}"
    ...
    # remove binaries that are known not to be hosted by bgcoincore.org
...
def main():
    ...
    pub_parser.add_argument(
        'version', type=str, help=(
            f'version of the bgcoin release to download; of the format '
    ...
    pub_parser.add_argument(
        ...
        help=(
            ...
            '(Sometimes blackgoldcoin.org lags behind bgcoincore.org.)')
    )
